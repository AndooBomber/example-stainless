import fs from 'fs';
import type { ResponseLike } from 'fuando-example-stainless/internal/to-file';
import { toFile } from 'fuando-example-stainless/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('fuando-example-stainless/core/uploads');
    await expect(

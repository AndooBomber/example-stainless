import { multipartFormRequestOptions, createForm } from 'fuando-example-stainless-2/core';
import { Blob } from 'fuando-example-stainless-2/_shims/index';
import { toFile } from 'fuando-example-stainless-2';

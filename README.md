...
[![NPM version](https://img.shields.io/npm/v/fuando-example-stainless-hoge.svg)](https://npmjs.org/package/fuando-example-stainless-hoge) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/fuando-example-stainless-hoge)
...
```sh
npm install fuando-example-stainless-hoge
```
...
<!-- prettier-ignore -->
```js
import Petstore from 'fuando-example-stainless-hoge';
...
To do the inverse, add `import "fuando-example-stainless-hoge/shims/node"` (which does import polyfills).
